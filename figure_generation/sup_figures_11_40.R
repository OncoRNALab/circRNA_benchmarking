...
#' # Sup Figure 22: percentage of circRNAs that were validated by one, two, or three methods
...
#' # Sup Figure 27: precision-recall dot plot
...
#ggsave('Supplementary_Figure_28.pdf', width = 20, height = 20, units = "cm")


#' # Sup Figure 29: sensitivity per cell line
...
#' # Sup Figure 30 & 31: same circRNAs in different cell lines
...
#ggsave('sup_figures/sup_figure_31.pdf', width = 21, height = 10, units = "cm")


#' # Sup Figure 32: relation between BSJ counts and Cq values
count_Cq = all_circ %>%
  inner_join(cq %>%
...
#ggsave('sup_figures/sup_figure_32.pdf',  width = 21, height = 21, units = "cm")



#' # Sup Figure 33: validation of circRNA compared to their presence in databases
val_db = cq %>% 
...
#' # Sup Figure 34: sensitivity of each database based on our study
...
cq_db_prec %>%
  ...
  xlab('') +
  ylab('precision (and number of observations)')


#ggsave('separate_figures/Supplementary_Figure_34_prec.pdf', width = 22, height = 17, units = "cm")


#' # Sup Figure 35: specificity of each database based on our study
...
#ggsave('separate_figures/Supplementary_Figure_35_sens.pdf', width = 21, height = 10, units = "cm")

#' # Sup Figure 36: number of times a circRNA was detected by more than one method + the percentage of circRNAs that were validated by one, two, or three methods 
...
#' # Sup Figure 38: combo of three tools
...
#' # Sup Figure 39: comparison with precision values from simulated data
...
#ggsave('Supplementary_Figure_39.pdf', width = 22, height = 15, units = "cm")



#' # Sup Figure 40: comparison with sensitivity from simulated data
