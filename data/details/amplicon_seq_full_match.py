...
for line_R1, line_R2 in zip(fastq_R1, fastq_R2):
	...
	# second fastq line: sequence => check or primers
		...
		if seq_sub_R1 in FWD_dict:
			...
			# if perfect match
			if seq_R1[0:len(FWD_match_R1)] == FWD_match_R1:
				PM_R1 = True
			...
			# if perfect match
			if seq_R1[0:len(REV_match_R1)] == REV_match_R1:
				PM_R1 = True
		...
		if seq_sub_R2 in FWD_dict:
			...
			# if perfect match
			if seq_R2[0:len(FWD_match_R2)] == FWD_match_R2:
				PM_R2 = True
			...
			if seq_R2[0:len(REV_match_R2)] == REV_match_R2:
				PM_R2 = True
		else:
